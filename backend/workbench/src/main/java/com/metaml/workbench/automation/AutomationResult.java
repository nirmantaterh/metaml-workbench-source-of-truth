...
// What a project's automation has to say about one twin activity. The summary is the line that ends up on the twin instance as proof the activity really ran; outputs are for anything the project wants a gateway further down its own model to be able to read.
